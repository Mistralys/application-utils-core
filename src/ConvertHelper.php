...
class ConvertHelper
{
    ...
    */
    ...
    {
        return VariableInfo::callback2string($callback);
    }

    public static function exception2info(Throwable $e) : ThrowableInfo
    {
        return ThrowableInfo::fromThrowable($e);
    }
    
    public static function throwable2info(Throwable $e) : ThrowableInfo
    {
        return ThrowableInfo::fromThrowable($e);
    }
